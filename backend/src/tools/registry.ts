...
// Suggestion buttons are generated by a separate flash model after the reply
// (see GeminiProvider.generateSuggestions), so they are no longer an inline tool
...
export const chatFunctionDeclarations: FunctionDeclaration[] = toolDefinitions.map(
  (t) => t.declaration
)
